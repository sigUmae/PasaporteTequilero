                    ...
                    <div class="table-responsive">
                      <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
                        ...
                        <?php foreach ($comisiones as $comision) { ?>
                          <tr>
                            <td class="center"><?php echo $comision['vendedor']?></td>
                            <td><?php echo $comision['comision']?></td>
                            <td><?php echo $comision['pagado']?></td>
                            <td><?php echo $comision['efectivo']?></td>
                            <td><?php echo $comision['no_pagado']?></td>
                            <td>
                              <div class="col-sm-2">
                                <a href="<?php echo base_url('config_pasaportes/comisiones?tipo=').$comision['tipo'].'&id='.md5($comision['id_vendedor'])?>">
                                  <button type="button" md-ink-ripple="" class="btn-ver-comision kit-width btn btn-fw btn-success waves-effect waves-effect">Ver más</button>
                                </a>
                              </div>
                            </td>
                          </tr>
