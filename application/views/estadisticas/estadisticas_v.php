                  ...
                  <div class="col-sm-4">
                    <div class="panel panel-card">
                      ...
                      <div class="panel-body text-center" style="height: 180px;">
                        <div class="m-v-lg">
                          Hoy
                          <div class="h2 text-success font-bold"><?php echo $total_ventas; ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="panel panel-card">
                      ...
                      <div class="panel-body text-center" style="height: 180px;">
                        <div class="m-v-lg">
                          Hoy
                          <div class="h2 text-success font-bold"><?php echo $total_visitas; ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="panel panel-card">
                      ...
                      <div class="panel-body text-center" style="height: 180px;">
                        <div class="m-v-lg">
                          Hoy
                          <div class="h2 text-success font-bold"><?php echo $total_kits; ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
