...
<div class="app">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body b-b b-light">
      ...
      <div class="col-sm-8" id="contain-options" data-id="rango_ventas"></div>
    </div>
                      ...
                      <?php } ?>
                        <div class="col-sm-2 m-t-n">
                          <a href="<?php echo base_url('ver_mas?pasaporte=').$value_p->id_pasaporte?>">
                            <!-- <button type="button" md-ink-ripple="" class="btn-kit kit-width btn btn-fw btn-success waves-effect waves-effect">Ver más</button> -->
