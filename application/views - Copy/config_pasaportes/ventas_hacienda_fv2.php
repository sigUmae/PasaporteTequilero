            ...
            <div class="card" ng-controller="MDInputCtrl">
                ...
                <div class="row row-sm">
                  <div class="col-sm-6">
                    <div class="md-form-group">
                      <input id="pasaporte" class="md-input md-input-white" ng-model="user.title">
                      <label>ID pasaporte</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="md-form-group">
                      <input class="md-input md-input-white no-display" ng-model="user.email">
                      <label>Tipo de pago</label>
                      <select id="pago" class="form-control select">
                        <option value="0">Seleccionar...</option>
                        <option value="1">Pago de contado</option>
                        <option value="2">Tarjeta</option>
                        <option value="3">Transferencia o cheque</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body">
                <div class="row row-sm">
                  <div class="col-sm-6">
                    <div class="md-form-group">
                      <input id="propietario" class="md-input" disabled="" ng-model="user.company">
                      <label>Propietario</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="md-form-group">
                      <input id="vendedor" class="md-input" disabled="" ng-model="user.company">
              ...
              <div class="card-body">
                <div class="row row-sm">
                  <div class="col-sm-6">
                    <div class="md-form-group">
                      <button id="info" md-ink-ripple="" class="btn btn-fw btn-info waves-effect waves-effect">Información</button>  
                      <button id="venta" md-ink-ripple="" class="btn btn-fw btn-success waves-effect waves-effect">Venta</button>  
                    </div>
                  </div>
              </div>
        </div>
