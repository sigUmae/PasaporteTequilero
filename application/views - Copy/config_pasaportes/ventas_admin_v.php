                  ...
                  <div class="row row-sm">
                    ...
                    <div class="col-sm-6">
                      <div class="md-form-group">
                        <input class="md-input md-input no-display">
                        <label>Elegir</label>
                        <select id="elegir" class="form-control select" required data-type="aliado">
                          <option value="">Seleccionar...</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="md-form-group">
                        <input id="propietario" class="md-input md-input" type="text" required>
                    ...
                    <div class="col-sm-4">
                      <div class="md-form-group">
                        ...
                        <select id="pago" class="form-control select" required>
                          <option value="">Seleccionar...</option>
                    ...
                    <div class="col-sm-4">
                      <div class="md-form-group">
                        <input id="telefono" class="md-input md-input" type="text">
                        <label>Teléfono</label>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="md-form-group">
                        <input id="correo" class="md-input md-input" type="email">
                        <label>Correo</label>
                      </div>
                    </div>
                     <div class="col-sm-8">
                      <div class="md-form-group">
                        <input id="domicilio" class="md-input md-input" type="text">
