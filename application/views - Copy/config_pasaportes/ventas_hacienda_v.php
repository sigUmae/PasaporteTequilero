              ...
              <div class="card" ng-controller="MDInputCtrl">
                ...
                <div class="card-body">
                  <div class="row row-sm">
                    ...
                    <div class="col-sm-5 no-display-tarjeta">
                      <div class="md-form-group">
                        <input id="num-tarjeta" name="num_tarjeta" class="md-input md-input" type="password" pattern="^[0-9]{13,16}$">
                        <label>Número tarjeta</label>
                      </div>
                    </div>
                    <div class="col-sm-5 no-display-tarjeta">
                      <div class="md-form-group">
                        <input id="r-num-tarjeta" name="r_num_tarjeta" class="md-input md-input" type="text" pattern="^[0-9]{13,16}$">
                        <label>Repetir número de tarjeta</label>
                      </div>
                    </div>
                    <div class="col-sm-4 no-display-tarjeta">
                      <div class="md-form-group">
                    ...
                    <div class="col-sm-4 no-display-tarjeta">
                      <div class="md-form-group">
                        <input id="c-seguridad" name="c-seguridad"  class="md-input md-input" type="text" pattern="^[0-9]{4}$">
